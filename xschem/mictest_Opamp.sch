...
N 170 -50 220 -50 {lab=vout}
N 220 -50 220 20 {lab=vout}
N 170 50 170 220 {lab=GND}
N 0 -0 0 40 {lab=virt}
N 0 40 110 40 {lab=virt}
N 20 -190 20 40 {lab=virt}
N 50 0 50 120 {lab=#net1}
N 50 0 110 0 {lab=#net1}
...
C {lab_wire.sym} 20 -60 0 0 {name=p5 sig_type=std_logic lab=virt
}
...
.ENDC  
"}
C {gnd.sym} 170 220 0 0 {name=l5 lab=GND}
C {opa_mod1.sym} 370 50 0 0 {name=x1}
